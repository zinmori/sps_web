    ...
    <div className="text-center bg-slate-200 w-4/5">
      ...
      <div className='flex justify-center'>
        <div className="mb-8 mx-4">
          ...
          >
            ...
            <option value="O moins">
              O-
            </option>
            <option value="A plus">
              A+
            </option>
            <option value="A moins">
              A-
            </option>
            <option value="B plus">
              B+
            </option>
            <option value="B moins">
              B-
            </option>
            <option value="AB plus">
              AB+
            </option>
            <option value="AB moins">
              AB-
            </option>
          </select>
      ...
      <div>
        ...
        <table className="border-collapse border border-gray-400 w-full">
          <thead>
            <tr>
              <th className="border border-gray-400 px-4 py-2">Date de signalement</th>
              <th className="border border-gray-400 px-4 py-2">Groupe Sanguin</th>
          ...
          <tbody>
            {urgences.map((urgence, index) => (
              <tr key={index}>
                <td className="border border-gray-400 px-4 py-2">{urgence.date}</td>
                <td className="border border-gray-400 px-4 py-2">{urgence.groupeSanguin}</td>
                <td className="border border-gray-400 px-4 py-2">{urgence.statut}</td>
                <td className="border border-gray-400 px-4 py-2">
                  {urgence.statut === 'Non satisfait' && (
                    <button onClick={() => handleStatutSatisfait(index)}>Marquer comme satisfait</button>
                  )}
                </td>
              </tr>
            ))}
